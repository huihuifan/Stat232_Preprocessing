...
\begin{frame}[fragile]
    ...
    Distribution of $T_i$ depends on $\sigma^2$ but is free of $B_{1i}$ so $T$ is a \textbf{partial pivot}- this example of preprocessing reducing the number of nuisance parameters. 
\end{frame}
